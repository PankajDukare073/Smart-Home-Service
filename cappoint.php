...
<?php session_start(); ?>
    ...
    <div class="row">
        ...
        <div class="col-9 vh-100 overflow-auto">
            <h6><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                </svg> Appoint Service Provider</h6>
            <div class="row">
                <table class="table table-hover" style="font-size: 15px;">
                    ...
                    <?php
                     include_once 'includes/conn.php';
          $query="select * from service where astatus='0'";
          $result=mysqli_query($conn,$query);
         while ($row=mysqli_fetch_array($result)){ ?>
                        <tr>
                        <form action="dbopertion.php" method="post" enctype="multipart/form-data">
                            ...
                            <td><?= $row['email']; ?></td>
                            <td><?= $row['mobile']; ?></td>
                            <input type='hidden' value="acustomer" name='filename'>
                            ...
                            <td><button style="border:none; background-color:transparent;" type="submit" name="rsp"><svg style="color: darkgreen;" xmlns="http://www.w3.org/2000/svg" width="25" height="25"
    ...
    <!-- Modal for view datails buisness -->
    <div class="modal fade" id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel2" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">View Buisness Datails</h5>
                ...
                <div class="modal-body">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <center>
                                    <h3>Pankaj Enterprizes</h3>
                                    <img src="./images/plumber-repairing-pipe-burst-woman-phoning-service-stop-house-flooding_74855-14142.webp"
                                        class="w-100" height="300px" alt="">
                                </center>
                            </div>
                        </div>
                        <div class="row">
    ...
    <div class="modal fade" id="staticBackdrop3" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered ">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Apply Filter</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="container">
