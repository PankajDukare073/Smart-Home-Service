    ...
    <div class="row">
        ...
        <div class="col-9 vh-100 overflow-auto">
            <h6><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                </svg> Approve Service Provider</h6>
            <div class="row">
                <table class="table table-hover" style="font-size: 15px;">
                    ...
                    <?php
                     include_once 'includes/conn.php';
          $query="select * from service where astatus='1'";
          $result=mysqli_query($conn,$query);
         while ($row=mysqli_fetch_array($result)){ ?>
                        <tr>
                            ...
                            <td> <button style="border:none; background-color:transparent;" type="submit" name="dspbtn"><svg style="color: red;" xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                ...
                                </svg></button> | <button style="border:none; background-color:transparent;" type="submit" name="aspbtn"> <svg type="submit" style="color: rgb(0, 176, 53);" xmlns="http://www.w3.org/2000/svg"
                                    width="25" height="25" fill="currentColor" class="bi bi-check-circle-fill"
                                    viewBox="0 0 16 16">
                                    <path
                ...
                <div class="modal-body">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <center>
                                    <h3><?php session_start(); echo $_SESSION['spid'] ?></h3>
