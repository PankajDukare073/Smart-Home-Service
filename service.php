            ...
            <div class="row">
                <div class="col-6 border border-success">
                    <center>
                        ...
                        <h3> <?php
                          include_once 'includes/conn.php';
                          $sql1 = "SELECT * FROM customer where role='Customer'";
...
?></h3>
                ...
                <div class="col-6 border border-success">
                    <center>
                        ...
                        <h3><?php 
                        $sid=$_SESSION['id'];
                        $sql2 = "SELECT distinct(cid) FROM appoint where spid='$aid'";
            ...
            <div class="row">
                <div class="col-6 border border-success">
                    <center>
                        ...
                        <h3><?php 
                        $spid=$_SESSION['id'];
                        $sql4 = "SELECT * FROM appoint where astatus='2' and spid='$spid'";
                ...
                <div class="col-6 border border-success">
                    <center>
                        ...
                        <h3><?php 
                        $spid=$_SESSION['id'];
                        $sql4 = "SELECT * FROM appoint where astatus='0' and spid='$spid'";
                        $result4=mysqli_query($conn,$sql4);
                        $rowcount4=mysqli_num_rows($result4);
